      ...
      <main id="main">
        ...
        <section id="setup" className="grid gap-10 py-20 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
          <div>
            ...
            <p className="mt-5 max-w-sm text-sm leading-7 text-muted">Clone your copy of <code className="text-ink">codesk</code>, open a terminal in its <code className="text-ink">cloudflare</code> folder, and run setup. It connects the pieces for you.</p>
          ...
          <div>
            <div className="overflow-hidden rounded-xl bg-[#172032] text-white shadow-lg shadow-slate-900/5">
              <div className="flex items-center justify-between border-b border-white/10 px-5 py-3">
                <span className="font-mono text-[10px] text-slate-400">TERMINAL · CODESK / CLOUDFLARE</span>
